...
// Nosso Mapa do Google.
export class Map {
  public map: google.maps.Map;
  private routes: { [id: string]: Route } = {}; // Para guardarmos as rotas na instância do Mapa.
  ...
  // Método para adicionar uma nova instancia de Rota para a nossa intancia do Mapa do Maps.
  addRoute(
    id: string,
    routeOptions: {
      currentMarkerOptions: google.maps.ReadonlyMarkerOptions;
...
// Ícone SVG do Ponto final da rota.
